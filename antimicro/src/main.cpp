...
int main(int argc, char *argv[])
{
    ...
    ArduinoConnector consoleConnector(joysticks, settings);
    //QObject::connect(w, &MainWindow::autoProfileLoaded, &consoleConnector, &ArduinoConnector::onAutoProfileLoaded);
